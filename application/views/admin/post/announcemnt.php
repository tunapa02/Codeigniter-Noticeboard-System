           ...
           <div class="row">
             ...
             <div class="col-md-6">
                 <div class="btn-group actions" role="group" aria-label="...">
                          <a href="post/add_posts" class="btn btn-default"><i class="glyphicon glyphicon-plus"></i> New</a>
            
                        <a href="post/inactive_post" class="btn btn-primary">Pending post <span class="badge"><?php if(count($count_post)) {echo $count_post;}else{echo 0;}  ?></span></a>      
             </div>
              ...
              <table class="table table-striped">
                 ...
                 <?php foreach($posts as $key => $value ): ?>
                  <tr>
                    ...
                    <td><?php echo anchor('admin/post/delete/'. $value['post_id'], '<i class="glyphicon glyphicon-remove"></i>'); ?></td>
                  </tr>
                 <?php endforeach; ?> 
              </table>
